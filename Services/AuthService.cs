...
namespace CCAP.Api.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<TokenViewModel> Login(LoginViewModel viewModel)
        {
            ...
            {
                throw new LoginFailedException($"Cannot allow the username: {viewModel.Username} to login.");
            }
        ...
        public async Task ChangePassword(ChangePasswordViewModel viewModel)
        {
            ...
            {
                throw new LoginFailedException($"Change password prevented for the non-existing user: {viewModel.Username}");
            }
            ...
            if (!currentPasswordResult)
            {
                ...
                throw new LoginFailedException($"Change password prevented for the user: {viewModel.Username}, as the current password doesn't match");
            }
        ...
        private TokenViewModel GetToken(AppUser appUser)
        {
            var claims = new List<Claim> {
                ...
                new Claim("username",appUser.Email)
            };
